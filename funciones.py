...
def show_graphs(data, variables, type="", d = None, escala=False, pagina = None):
    ...
    if "Diferencia" in data.columns and data["Diferencia"].sum() == 0:
        st.write(f"La comparación no es posible, ya que no hay diferencia en el dominio {d} entre los años seleccionados.")
        return
